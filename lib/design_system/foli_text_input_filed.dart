...
class FoliTextInputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      data: ThemeData(primaryColor: foliPrimaryColor),
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          fillColor: foliGreyExtraLightColor,
          prefixIcon: leading,
          ...
          focusedBorder: circularBorder.copyWith(
            borderSide: const BorderSide(color: foliPrimaryColor),
          ),
